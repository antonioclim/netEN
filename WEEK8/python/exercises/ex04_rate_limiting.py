...
class RateLimiter:
    ...
    - to fiecare request noua:
      ...
      3. Daca da, adauga timestamp-ul curent and permite requesta
      4. Daca nu, refuza requesta (429)
    ...
    def check(self, client_ip: str) -> bool:
        ...
        2. Cu lock tinut:
           ...
           c. Daca < max_requests: adauga timestamp curent, return True
    ...
    def cleanup_expired(self):
        ...
        # 4. Daca lista e goala, sterge IP-ul din dictionar
