...
INTERFACE="any"
DURATION=20
# Include both SSH ports:
# - 22: intra-Docker traffic (container-to-container)
# - 2222: host port mapping
FILTER="tcp port 8000 or tcp port 8443 or tcp port 5000 or tcp port 22 or tcp port 2222 or tcp port 2121 or udp port 5353"
