...
def handle_client(client_socket: socket.socket, client_addr: tuple[str, int]) -> None:
    ...
    print(f"[CONNECT] {client_name} ({ip}:{port}) connected. Total: {get_client_count()}")
    ...
    # ═══════════════════════════════════════════════════════════════════════
    # TODO: Anuntati ceitolti clienti ca connected cineva nou
    ...
    try:
        ...
        print(f"[WARN] {client_name} - connection reset")
    except OSError as e:
        ...
        # ═══════════════════════════════════════════════════════════════════
        # TODO: Anuntati ceitolti clienti ca disconnected
        ...
        print(f"[DISCONNECT] {client_name} disconnected. Total: {get_client_count()}")
...
def run_server(host: str, port: int) -> int:
    ...
    try:
        ...
        print(f"║  Listening on: {host}:{port:<42}║")
        print("╚══════════════════════════════════════════════════════════════╝")
        print("[INFO] Waiting for connections... (Test: nc localhost " + str(port) + ")")
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        ...
        description="Template: TCP Chat Server with broadcast"
    )
