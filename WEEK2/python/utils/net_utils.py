"""Utilitare S2 for rapid analysis of capturi exportate from tshark.

In the laboratory, it is useful to quickly extract several fields and aggregate them (ex. TCP flags, ports).

This module avoids external dependencies (pandas etc.) to run on minimal VM.
"""
