...
# Test 4: kit files present
echo -n "  [4] kit files present... "
...
# Test 8: X-Backend header present
echo -n "  [8] X-Backend header present... "
...
echo -n "  [12] X-Served-By header present... "
