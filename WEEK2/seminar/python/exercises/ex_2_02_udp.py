...
"""
═══════════════════════════════════════════════════════════════════════════════
 Week 2 – Exercise 2: UDP server and client with Protocol Aplicatie
═══════════════════════════════════════════════════════════════════════════════

 OBIECTIVE:
 1. Socket-uri UDP (SOCK_DGRAM)
 2. Difference TCP vs UDP (connectionless)
 3. Protocol aplicatie peste UDP
 ...
 USAGE:
   ...
   O command:  python3 ex_2_02_udp.py client --host 127.0.0.1 --port 9998 -o "ping"
═══════════════════════════════════════════════════════════════════════════════
"""
...
def process_command(data: bytes) -> bytes:
    """processes comanda conform protocolului."""
    try:
...
def run_server(cfg: ServerConfig) -> None:
    ...
    log("server", "waiting datagrame... (Ctrl+C stopping)")
