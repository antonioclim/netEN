...
Open the file `python/exercises/ex_01_http_server.py` and completee the sections marked with `# TODO`.
...
Open `python/exercises/ex_02_reverse_proxy.py` and completee:
...
- [ ] I completeed at least one exercise (ex_01 or ex_02)
